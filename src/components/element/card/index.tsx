...
const Card = ({ product, gift }: Props) => {
  return (
    <div className="bg-white  h-[308px] w-[180Propspx]">
      <div className="p-[16px] ">
        <div className="relative">
          <img
            className="w-[147px] h-[147px]"
            src="https://lh3.googleusercontent.com/kLQl_XgI9Mva_lm8hvS93C8Vl01eb2DsGjlTn175GajK431wsgc__NjfvERiox1odh7OYynd7vKTvh1cdV4uJvquocBq1HxR=w230-rw"
          />
          <div className=" px-[8px] py-[4px] h-[36px] rounded absolute bottom-0 bg-[url('data:image/svg+xml;base64,')]">
            <div className="text-[10px]">Tiết kiệm</div>
            <div className="text-[13px]">1.400.000₫</div>
          </div>
        </div>
        <div className="text-[13px] text-[#82869E] mb-[4px]">
          {product.name}
        </div>
        <div className="text-[12px] text-[#434657]">
          Màn hình LCD Dell 24" U2422H (1920 x 1080/IPS/60Hz/5 ms)
        </div>
        <div className="text-[15px] text-[#1435C3] font-bold">5.690.000 ₫</div>
        <span className="text-[12px] text-[#82869E] line-through">
          7.090.000 ₫
        </span>
        <span className="text-[12px] text-[#1435C3]"> -19.75%</span>
      </div>
    </div>
  );
};
